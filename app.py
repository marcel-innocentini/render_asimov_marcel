...
#trecho referente colorização dos gráficos no mesmo tema do dashboard (necessário referenciar nas figs tb...)
...
app.layout = html.Div(children = [
                dbc.Row([
                    dbc.Col([
                       dbc.Card([
                            html.H2("AGROPIXEL", style={"font-family": "Montserrat", "font-size": "35px"}),
                            html.Hr(),
                            html.H5("Cidades:"),
                            dcc.Checklist(df_data["City"].unique(), df_data["City"].unique(), id="check_city", inputStyle={"margin-right":"5px", "margin-left": "20px"}),
...
def render_graphs(cities, main_variable):
    ...
    #veja que no trecho abaixo x e y foram trocados de lugar para criar gráfico de barras invertido
...
# os retornos da função tem que obeder a ordem dos Outputs
